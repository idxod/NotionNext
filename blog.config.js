...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3800396330d480ee875bd42a16956638',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '数据分析工作室', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://book.yewu120.com', // 网站地址
